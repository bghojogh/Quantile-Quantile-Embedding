...
path_save = "./results/synthetic_separation/"
...
evaluate_embedding(embedding=X.T, labels=y, path_save_accuracy_of_test_data=path_save+"initial/", k_list=[1, 2, 4, 8, 16], name="initial")
...
for class_index in range(3):
    ...
    evaluate_embedding(embedding=X_multiclass_to_plot.T, labels=y, path_save_accuracy_of_test_data=path_save, k_list=[1, 2, 4, 8, 16], name="class" + str(class_index) + "_itr" + str(itr))
